...
import statuses.*;
public class BossRushSkillFullCleave extends BossRushSkills{
    
    public BossRushSkillFullCleave() {
        super();
        this.setName("Full Cleave");
        this.setType("ATK");
        this.setDescription("Strong downward swing.");
        this.setHpCost("0");
        this.setMpCost("20");
        this.setPotency("350");
    }
